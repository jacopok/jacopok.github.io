...
L’editto parla di un antico regno nanico, dei suoi grandi **tesori** ormai sepolti e fantastica su come potrebbe essere esaltata la Burlanija dal rinvenire i frutti dell’artigianato nanico, ben al di là di qualunque cosa possa essere prodotta al giorno d’oggi.
...
- La **razza**, ovvero il popolo e l’etnia da cui fa parte il personaggio (vedi [Razze in Burlanija](#razze-in-burlanija))
- La **classe**, ovvero il "mestiere" del tuo personaggio (vedi [Classi in Burlanija](#classi-in-burlanija))
- Il **background**, le origini del tuo personaggio (vedi [Background in Burlanija](#background-in-burlanija))
- L'**inventario**, il materiale in possesso del tuo personaggio (vedi [Inventario](#inventario))
...
Puoi trovare un'ampia lista di archetipi di background su [wikidot](http://dnd5e.wikidot.com/#toc3), oppure una più ristretta nelle [basic rules](https://www.dndbeyond.com/sources/dnd/basic-rules-2014/personality-and-background#Backgrounds).
